...
def get_hidden_word_with_visible_guessed_letters(word, guessed_letters: list):
    new_list = []
    exist = False
    for i in word:
...
def update_letters_to_be_guessed(hidden_letters: set, letter):
    # for i in hidden_letters:
    #     if i == letter:
